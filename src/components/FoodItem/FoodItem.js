...
//   const {cartItem,setCartItem,addToCart,removeCartItem}= useContext(StoreContext);
//   return (
...
//          {
//           !cartItem[id]
//           ? <img className='add' onClick={()=>addToCart(id)} src={assets.addIcon} alt="image" />
//           :<div className='food-item-counter'>
//           <img onClick={()=>removeCartItem(id)} src={assets.removeIcon} alt="image" />
//           <p>{cartItem[id]}</p>
//           <img onClick={()=>addToCart(id)} src={assets.addedIcon} alt="image" />
//           </div>
...
//            <img src={assets.rating} alt="star-rating" />
//            </div>
